...
const index: DataIndex = {
  ...
  needs: [
    { id: "N-001", title: "fixed notification area", module: "Shell", raised_by: "Cleo", status: "unwritten", requirements: [], sources: [{ meeting: "11 Sep sync", offset: "19:56", at: "2026-09-11T17:50" }], prototype: { state: "none" }, need: "As an operator, I want every system event in one place." },
    { id: "N-002", title: "APP-6 symbology", module: "Map", raised_by: "Ada · Ben", status: "covered", requirements: ["REQ-HMI-039"], sources: [], prototype: { state: "built" }, need: "As an operator, I want tracks drawn in NATO symbology." },
  ],
  requirements: [
